...
CREATE INDEX idx_period_administration ON income_administration (period_code, administration_code);

-- SalesAdministration 테이블
DROP INDEX idx_period_code ON sales_administration;
DROP INDEX idx_administration_code ON sales_administration;
DROP INDEX idx_service_code ON sales_administration;
CREATE INDEX idx_period_administration_service ON sales_administration (period_code, administration_code, service_code);

-- AreaCommercial 테이블
DROP INDEX idx_district_code ON area_commercial;
DROP INDEX idx_administration_code ON area_commercial;
CREATE INDEX idx_district_code ON area_commercial (district_code);
CREATE INDEX idx_administration_code ON area_commercial (administration_code);
